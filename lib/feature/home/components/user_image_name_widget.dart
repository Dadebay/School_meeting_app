      ...
      child: Row(
        ...
        children: [
                ...
                RichText(
                  ...
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: '${ref.watch(userUpdateProvider).username ?? 'User'}!',
                        style: context.general.textTheme.headlineMedium?.copyWith(
          ...
          Container(
              ...
              child: ClipRRect(borderRadius: context.border.lowBorderRadius, child: CustomWidgets.imageWidget(state.imagePath, true))),
        ],
      ),
    );
  }
